...
const Hero = () => {
    ...
    const nextVideoRef = useRef<any | null>(null);
        ...
        <div className="relative h-dvh w-screen overflow-x-hidden" id="home">
            ...
            <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden  bg-(--blue-75)">
                <div className="mask-clip-path absolute-center absolute z-50 size-64 cursor-pointer overflow-hidden rounded-lg">
                    <div onClick={handleMiniVidClick} className="origin-center scale-50 opacity-0 transition-all duration-500 ease-in hover:opacity-100 hover:scale-100">
                        <video
                            ref={nextVideoRef}
                            loop
                            muted
