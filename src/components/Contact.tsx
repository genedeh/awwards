    ...
    return (
        <div id="contact" className="my-20 min-h-96 w-screen px-10">
            <div className="relative rounded-lg bg-black py-24 text-(--blue-50) sm:overflow-hidden">
                <div className="absolute -left-20 top-0 hidden h-full w-72 overflow-hidden sm:block lg:left-20 left:w-96">
                ...
                <div className="absolute -top-40 left-20 w-60 sm:top-1/2 md:left-auto lg:right-10 lg:top-20 lg:w-80">
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <p className='special-font mt-10 w-full font-zentry text-5xl leading-[0.9] md:text-[6rem] z-10'>Let&apos;s b<b>u</b>ild the <br /> new era of <br /> g<b>a</b>ming t<b>o</b>gether</p>
